class VoIPException implements Exception {
  ...
  // TODOtest if permamently denied permissions will be reseted after app reinstall.
  // TODOimplements open app settings page to allows user to manually autorize the permission
