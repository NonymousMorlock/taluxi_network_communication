...
//   final fakeNotificationData = {'key': 'value', 'key1': 'value1', 'key2': 5};
...
//       expect(
//         (await receivedNotification).title,
//         fakeNotificationPayLoad['title'],
//       );
//     });
//
//     test(
...
//             (e) => e.exceptionType,
//             'Exception type',
//             equals(NotificationExceptionType.unknown),
//           ),
//         ),
//       );
//     });
